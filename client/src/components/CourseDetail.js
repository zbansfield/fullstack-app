                ...
                <form>
                    <div class="main--flex">
                        <div>
                            ...
                            <h4 class="course--name">{ context.course.title }</h4>
                            <p>By {`${context.course.user.firstName} ${context.course.user.firstName}`}</p>
                        ...
                        <div>
                            ...
                            <p>{context.course.estimatedTime}</p>
